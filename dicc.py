class Dicc:
	...
	def __init__(self):
		...
		self.mnemonicos={'push':'0014','pop':'0015', 'add':['0016','0017','0018','0019'], 'dec':'001A', 'sub':['001B','001C','001D','001E'], 'mul':['001F','0020','0021','0022'], 'div':['0023','0024','0025','0026'], 'inc':'0027', 'cmp':'0028', 'and':'0029', 'readN':'003B', 'readCh':'003C', 'readS':'003D', 'tff':'003E', 'call':'002F', 'ret':'0030', 'jmpz':'0031', 'jmpnz':'0032', 'jmp':'0033', 'jmpp':'0034', 'jmpn':'0035', 'test':'002E', 'nop':'002D', 'not':'002C', 'xor':'002B', 'or':'002A','mov':['0010','0011','0012','0013'],'printN':['0036','0037'],'printCh':['0038','0039'],'printS':['003A']}
